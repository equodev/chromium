...
class CefDropTargetListener implements DropTargetListener {
    ...
    public void dragEnter(DropTargetDragEvent event) {
        ...
        browser_.dragTargetDragEnter(
                dragData_, new Point(event.getLocation().x, event.getLocation().y), dragModifiers_, dragOperations_);
    }
    ...
    public void dragOver(DropTargetDragEvent event) {
        AssertDragData();
        browser_.dragTargetDragOver(new Point(event.getLocation().x, event.getLocation().y), dragModifiers_, dragOperations_);
    }
    ...
    public void drop(DropTargetDropEvent event) {
        AssertDragData();
        browser_.dragTargetDrop(new Point(event.getLocation().x, event.getLocation().y), dragModifiers_);
