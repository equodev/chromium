 ...
 */
 ...
 public static final class StringWide extends Struct {
     ...
     public Function<Dtor> dtor = new Function<>(Dtor.class);
     public static interface Dtor {
         @Delegate
         void invoke(Pointer int_);
     }
 ...
 public static final class Cookie extends Struct {
     ...
     public byte creation = new byte();
     public byte lastAccess = new byte();
     public Signed32 hasExpires = new Signed32();
     public byte expires = new byte();
 ...
 public static final class Geoposition extends Struct {
     ...
     public byte timestamp = new byte();
 ...
 public static final class Base extends Struct {
     public UnsignedLong size = new UnsignedLong();
     public Function<AddRef> addRef = new Function<>(AddRef.class);
     public static interface AddRef {
         @Delegate
         void invoke(Pointer base);
     }
     public void setAddRef(AddRef callback) {
         addRef.set(callback);
     }
     
     public Function<Release> release = new Function<>(Release.class);
     public static interface Release {
         @Delegate
         int invoke(Pointer base);
     }
     public void setRelease(Release callback) {
         release.set(callback);
     }
     
     public Function<HasOneRef> hasOneRef = new Function<>(HasOneRef.class);
 ...
 public static final class CommandLine extends Struct {
     ...
     public Function<IsValid> isValid = new Function<>(IsValid.class);
     public static interface IsValid {
         @Delegate
         int invoke(Pointer commandLine);
     }
     public void setIsValid(IsValid callback) {
         isValid.set(callback);
     }
     
     public Function<IsReadOnly> isReadOnly = new Function<>(IsReadOnly.class);
     ...
     public Function<Copy> copy = new Function<>(Copy.class);
     public static interface Copy {
         @Delegate
         Pointer invoke(Pointer commandLine);
     }
     public void setCopy(Copy callback) {
         copy.set(callback);
     }
     
     public Function<InitFromArgv> initFromArgv = new Function<>(InitFromArgv.class);
     public static interface InitFromArgv {
         @Delegate
         void invoke(Pointer commandLine, int int_, Pointer charS);
     }
     public void setInitFromArgv(InitFromArgv callback) {
         initFromArgv.set(callback);
     }
     
     public Function<InitFromString> initFromString = new Function<>(InitFromString.class);
     public static interface InitFromString {
         @Delegate
         void invoke(Pointer commandLine, StringUtf16 stringUtf16);
     }
     public void setInitFromString(InitFromString callback) {
         initFromString.set(callback);
     }
     
     public Function<Reset> reset = new Function<>(Reset.class);
     public static interface Reset {
         @Delegate
         void invoke(Pointer commandLine);
     }
     public void setReset(Reset callback) {
         reset.set(callback);
     }
     
     public Function<GetArgv> getArgv = new Function<>(GetArgv.class);
     public static interface GetArgv {
         @Delegate
         void invoke(Pointer commandLine, Pointer void_);
     }
     public void setGetArgv(GetArgv callback) {
         getArgv.set(callback);
     }
     
     public Function<GetCommandLineString> getCommandLineString = new Function<>(GetCommandLineString.class);
     public static interface GetCommandLineString {
         @Delegate
         StringUtf16 invoke(Pointer commandLine);
     }
     public void setGetCommandLineString(GetCommandLineString callback) {
         getCommandLineString.set(callback);
     }
     
     public Function<GetProgram> getProgram = new Function<>(GetProgram.class);
     ...
     public Function<SetProgram> setProgram = new Function<>(SetProgram.class);
     ...
     public Function<HasSwitches> hasSwitches = new Function<>(HasSwitches.class);
     ...
     public Function<HasSwitch> hasSwitch = new Function<>(HasSwitch.class);
     public static interface HasSwitch {
         @Delegate
         int invoke(Pointer commandLine, StringUtf16 stringUtf16);
     }
     public void setHasSwitch(HasSwitch callback) {
         hasSwitch.set(callback);
     }
     
     public Function<GetSwitchValue> getSwitchValue = new Function<>(GetSwitchValue.class);
     public static interface GetSwitchValue {
         @Delegate
         StringUtf16 invoke(Pointer commandLine, StringUtf16 stringUtf16);
     }
     public void setGetSwitchValue(GetSwitchValue callback) {
         getSwitchValue.set(callback);
     }
     
     public Function<GetSwitches> getSwitches = new Function<>(GetSwitches.class);
     ...
     public Function<AppendSwitch> appendSwitch = new Function<>(AppendSwitch.class);
     ...
     public Function<AppendSwitchWithValue> appendSwitchWithValue = new Function<>(AppendSwitchWithValue.class);
     public static interface AppendSwitchWithValue {
         @Delegate
         void invoke(Pointer commandLine, StringUtf16 stringUtf16, StringUtf16 stringUtf16);
     }
     public void setAppendSwitchWithValue(AppendSwitchWithValue callback) {
         appendSwitchWithValue.set(callback);
     }
     
     public Function<HasArguments> hasArguments = new Function<>(HasArguments.class);
     ...
     public Function<GetArguments> getArguments = new Function<>(GetArguments.class);
     ...
     public Function<AppendArgument> appendArgument = new Function<>(AppendArgument.class);
     ...
     public Function<PrependWrapper> prependWrapper = new Function<>(PrependWrapper.class);
 ...
 public static final class BrowserProcessHandler extends Struct {
     public Base base = inner(new Base((getRuntime()));
     public Function<OnContextInitialized> onContextInitialized = new Function<>(OnContextInitialized.class);
     public static interface OnContextInitialized {
         @Delegate
         void invoke(Pointer browserProcessHandler);
     }
     public void setOnContextInitialized(OnContextInitialized callback) {
         onContextInitialized.set(callback);
     }
     
     public Function<OnBeforeChildProcessLaunch> onBeforeChildProcessLaunch = new Function<>(OnBeforeChildProcessLaunch.class);
     public static interface OnBeforeChildProcessLaunch {
         @Delegate
         void invoke(Pointer browserProcessHandler, CommandLine commandLine);
     }
     public void setOnBeforeChildProcessLaunch(OnBeforeChildProcessLaunch callback) {
         onBeforeChildProcessLaunch.set(callback);
     }
     
     public Function<OnRenderProcessThreadCreated> onRenderProcessThreadCreated = new Function<>(OnRenderProcessThreadCreated.class);
     public static interface OnRenderProcessThreadCreated {
         @Delegate
         void invoke(Pointer browserProcessHandler, Pointer listValue);
     }
     ...
     public Function<GetPrintHandler> getPrintHandler = new Function<>(GetPrintHandler.class);
     public static interface GetPrintHandler {
         @Delegate
         Pointer invoke(Pointer browserProcessHandler);
     }
 ...
 public static final class App extends Struct {
     public Base base = inner(new Base((getRuntime()));
     public Function<OnBeforeCommandLineProcessing> onBeforeCommandLineProcessing = new Function<>(OnBeforeCommandLineProcessing.class);
     public static interface OnBeforeCommandLineProcessing {
         @Delegate
         void invoke(Pointer app, StringUtf16 stringUtf16, CommandLine commandLine);
     }
     ...
     public Function<OnRegisterCustomSchemes> onRegisterCustomSchemes = new Function<>(OnRegisterCustomSchemes.class);
     public static interface OnRegisterCustomSchemes {
         @Delegate
         void invoke(Pointer app, Pointer schemeRegistrar);
     }
     public void setOnRegisterCustomSchemes(OnRegisterCustomSchemes callback) {
         onRegisterCustomSchemes.set(callback);
     }
     
     public Function<GetResourceBundleHandler> getResourceBundleHandler = new Function<>(GetResourceBundleHandler.class);
     public static interface GetResourceBundleHandler {
         @Delegate
         Pointer invoke(Pointer app);
     }
     public void setGetResourceBundleHandler(GetResourceBundleHandler callback) {
         getResourceBundleHandler.set(callback);
     }
     
     public Function<GetBrowserProcessHandler> getBrowserProcessHandler = new Function<>(GetBrowserProcessHandler.class);
     public static interface GetBrowserProcessHandler {
         @Delegate
         BrowserProcessHandler invoke(Pointer app);
     }
     public void setGetBrowserProcessHandler(GetBrowserProcessHandler callback) {
         getBrowserProcessHandler.set(callback);
     }
     
     public Function<GetRenderProcessHandler> getRenderProcessHandler = new Function<>(GetRenderProcessHandler.class);
