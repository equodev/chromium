...
public class CEF {
    ...
    */
    ...
    public static final class StringUtf8 extends InnerStruct {
        ...
        public StringUtf8(jnr.ffi.Runtime runtime, Struct st) {
          super(runtime, st);
        }
    }
    ...
    public static final class StringUtf16 extends InnerStruct {
    	public UTF16StringRef str = new UTF16StringRef(100);
//    	public UTF8StringRef str = new UTF8StringRef(100);
//        public u_int8_t str = new u_int8_t();
        public size_t length = new size_t();
        public Pointer dtor = new Pointer();
        public StringUtf16() {
          super(RUNTIME);
...
//    }
     ...
     * @scope class
     */
//    public static int stringAsciiToUtf16(String src, NativeLong srcLen, PointerByReference output) {
...
//    }
    ...
    public static final class Settings extends Struct {
        ...
        public StringUtf16 browser_subprocess_path = inner(new StringUtf16(getRuntime()));
        ...
        public StringUtf16 cache_path = inner(new StringUtf16(getRuntime()));
        public StringUtf16 user_data_path = inner(new StringUtf16(getRuntime()));
        public Signed32 persist_session_cookies = new Signed32();
        public Signed32 persist_user_preferences = new Signed32();
        public StringUtf16 user_agent = inner(new StringUtf16(getRuntime()));
        public StringUtf16 product_version = inner(new StringUtf16(getRuntime()));
        public StringUtf16 locale = inner(new StringUtf16(getRuntime()));
        public StringUtf16 log_file = inner(new StringUtf16(getRuntime()));
        public Enum<LogSeverity> log_severity = new Enum<>(LogSeverity.class);
        public StringUtf16 javascript_flags = inner(new StringUtf16(getRuntime()));
        public StringUtf16 resources_dir_path = inner(new StringUtf16(getRuntime()));
        public StringUtf16 locales_dir_path = inner(new StringUtf16(getRuntime()));
        ...
        public StringUtf16 accept_language_list = inner(new StringUtf16(getRuntime()));
        public Settings() {
          super(RUNTIME);
        }
...
//        TT_QUALIFIER_MASK(4294967040)
    ...
    public static final class Base extends Struct {
        ...
        public Base(jnr.ffi.Runtime runtime, Struct enclosing) {
...
//    		return 1;
    ...
    public interface CEFInterface {
        ...
        int stringWideSet(String src, int srcLen, StringWide output, int copy);
        
        @NativeName("cef_string_utf8_set")
        int stringUtf8Set(String src, int srcLen, StringUtf8 output, int copy);
        
        @NativeName("cef_string_utf16_set")
        int stringUtf16Set(@In String src, int srcLen, @Transient StringUtf16 output, int copy);
        ...
        int stringUtf8ToUtf16(String src, long srcLen, @Clear StringUtf16 output);
