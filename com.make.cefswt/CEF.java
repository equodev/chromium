...
public class CEF {
    ...
    */
     ...
     * (Not documented)
     */
    public static final class SchemeHandlerFactory extends Struct {
        // hidden structure
        public SchemeHandlerFactory(jnr.ffi.Runtime runtime) {
          super(runtime);
        }
    }
     ...
     * :onResolveCompleted ::
     *   (Function(OnResolveCompleted)) Called after the ResolveHost request has completed. |result| will be the
     *   result code. |resolved_ips| will be the list of resolved IP addresses or
     *   NULL if the resolution failed.
     */
    public static final class ResolveCallback extends Struct {
        public BaseRefCounted base = inner(new BaseRefCounted(getRuntime()));
        public Function<OnResolveCompleted> onResolveCompleted = function(OnResolveCompleted.class);
        public static interface OnResolveCompleted {
            @Delegate
            void invoke(jnr.ffi.Pointer resolveCallback, Errorcode errorcode_1, jnr.ffi.Pointer void_2);
        }
        public void setOnResolveCompleted(OnResolveCompleted callback) {
            onResolveCompleted.set(callback);
        }
        
        public ResolveCallback(jnr.ffi.Runtime runtime) {
          super(runtime);
        }
    }
     ...
     *   (BaseRefCounted) Base structure.
     * :isSame ::
     *   (Function(IsSame)) Returns true (1) if this object is pointing to the same context as |that|
     *   object.
     * :isSharingWith ::
     *   (Function(IsSharingWith)) Returns true (1) if this object is sharing the same storage as |that|
     *   object.
     * :isGlobal ::
     *   (Function(IsGlobal)) Returns true (1) if this object is the global context. The global context
     *   is used by default when creating a browser or URL request with a NULL
     *   context argument.
     * :getHandler ::
     *   (Function(GetHandler)) Returns the handler for this context if any.
     * :getCachePath ::
     *   (Function(GetCachePath)) The resulting string must be freed by calling cef_string_userfree_free().
     * :getDefaultCookieManager ::
     *   (Function(GetDefaultCookieManager)) Returns the default cookie manager for this object. This will be the global
     ...
     *   (Function(RegisterSchemeHandlerFactory)) Register a scheme handler factory for the specified |scheme_name| and
     ...
     *   (Function(ClearSchemeHandlerFactories)) Clear all registered scheme handler factories. Returns false (0) on error.
     *   This function may be called on any thread in the browser process.
     * :purgePluginListCache ::
     *   (Function(PurgePluginListCache)) Tells all renderer processes associated with this context to throw away
     ...
     * :hasPreference ::
     *   (Function(HasPreference)) Returns true (1) if a preference with the specified |name| exists. This
     *   function must be called on the browser process UI thread.
     * :getPreference ::
     *   (Function(GetPreference)) Returns the value for the preference with the specified |name|. Returns
     *   NULL if the preference does not exist. The returned object contains a copy
     *   of the underlying preference value and modifications to the returned object
     *   will not modify the underlying preference value. This function must be
     *   called on the browser process UI thread.
     * :getAllPreferences ::
     *   (Function(GetAllPreferences)) Returns all preferences as a dictionary. If |include_defaults| is true (1)
     ...
     *   thread.
     * :canSetPreference ::
     *   (Function(CanSetPreference)) Returns true (1) if the preference with the specified |name| can be
     *   modified using SetPreference. As one example preferences set via the
     *   command-line usually cannot be modified. This function must be called on
     *   the browser process UI thread.
     * :setPreference ::
     *   (Function(SetPreference)) Set the |value| associated with preference |name|. Returns true (1) if the
     *   value is set successfully and false (0) otherwise. If |value| is NULL the
     *   preference will be restored to its default value. If setting the preference
     *   fails then |error| will be populated with a detailed description of the
     *   problem. This function must be called on the browser process UI thread.
     * :clearCertificateExceptions ::
     *   (Function(ClearCertificateExceptions)) Clears all certificate exceptions that were added as part of handling
     ...
     *   completion.
     * :closeAllConnections ::
     *   (Function(CloseAllConnections)) Clears all active and idle connections that Chromium currently has. This is
     *   only recommended if you have released all other CEF objects but don't yet
     *   want to call cef_shutdown(). If |callback| is non-NULL it will be executed
     *   on the UI thread after completion.
     * :resolveHost ::
     *   (Function(ResolveHost)) Attempts to resolve |origin| to a list of associated IP addresses.
     *   |callback| will be executed on the UI thread after completion.
     * :resolveHostCached ::
     *   (Function(ResolveHostCached)) Attempts to resolve |origin| to a list of associated IP addresses using
     ...
     */
    public static final class RequestContext extends Struct {
        public BaseRefCounted base = inner(new BaseRefCounted(getRuntime()));
        public Function<IsSame> isSame = function(IsSame.class);
        public static interface IsSame {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer requestContext_1);
        }
        public void setIsSame(IsSame callback) {
            isSame.set(callback);
        }
        
        public Function<IsSharingWith> isSharingWith = function(IsSharingWith.class);
        public static interface IsSharingWith {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer requestContext_1);
        }
        public void setIsSharingWith(IsSharingWith callback) {
            isSharingWith.set(callback);
        }
        
        public Function<IsGlobal> isGlobal = function(IsGlobal.class);
        public static interface IsGlobal {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext);
        }
        public void setIsGlobal(IsGlobal callback) {
            isGlobal.set(callback);
        }
        
        public Function<GetHandler> getHandler = function(GetHandler.class);
        public static interface GetHandler {
            @Delegate
            jnr.ffi.Pointer invoke(jnr.ffi.Pointer requestContext);
        }
        public void setGetHandler(GetHandler callback) {
            getHandler.set(callback);
        }
        
        public Function<GetCachePath> getCachePath = function(GetCachePath.class);
        public static interface GetCachePath {
            @Delegate
            StringUtf16 invoke(jnr.ffi.Pointer requestContext);
        }
        public void setGetCachePath(GetCachePath callback) {
            getCachePath.set(callback);
        }
        
        public Function<GetDefaultCookieManager> getDefaultCookieManager = function(GetDefaultCookieManager.class);
        public static interface GetDefaultCookieManager {
            @Delegate
            jnr.ffi.Pointer invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer completionCallback_1);
        }
        public void setGetDefaultCookieManager(GetDefaultCookieManager callback) {
            getDefaultCookieManager.set(callback);
        }
        
        public Function<RegisterSchemeHandlerFactory> registerSchemeHandlerFactory = function(RegisterSchemeHandlerFactory.class);
        public static interface RegisterSchemeHandlerFactory {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1, jnr.ffi.Pointer stringUtf16_2, jnr.ffi.Pointer schemeHandlerFactory_3);
        }
        public void setRegisterSchemeHandlerFactory(RegisterSchemeHandlerFactory callback) {
            registerSchemeHandlerFactory.set(callback);
        }
        
        public Function<ClearSchemeHandlerFactories> clearSchemeHandlerFactories = function(ClearSchemeHandlerFactories.class);
        public static interface ClearSchemeHandlerFactories {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext);
        }
        public void setClearSchemeHandlerFactories(ClearSchemeHandlerFactories callback) {
            clearSchemeHandlerFactories.set(callback);
        }
        
        public Function<PurgePluginListCache> purgePluginListCache = function(PurgePluginListCache.class);
        public static interface PurgePluginListCache {
            @Delegate
            void invoke(jnr.ffi.Pointer requestContext, int int_1);
        }
        public void setPurgePluginListCache(PurgePluginListCache callback) {
            purgePluginListCache.set(callback);
        }
        
        public Function<HasPreference> hasPreference = function(HasPreference.class);
        public static interface HasPreference {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1);
        }
        public void setHasPreference(HasPreference callback) {
            hasPreference.set(callback);
        }
        
        public Function<GetPreference> getPreference = function(GetPreference.class);
        public static interface GetPreference {
            @Delegate
            jnr.ffi.Pointer invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1);
        }
        public void setGetPreference(GetPreference callback) {
            getPreference.set(callback);
        }
        
        public Function<GetAllPreferences> getAllPreferences = function(GetAllPreferences.class);
        public static interface GetAllPreferences {
            @Delegate
            jnr.ffi.Pointer invoke(jnr.ffi.Pointer requestContext, int int_1);
        }
        public void setGetAllPreferences(GetAllPreferences callback) {
            getAllPreferences.set(callback);
        }
        
        public Function<CanSetPreference> canSetPreference = function(CanSetPreference.class);
        public static interface CanSetPreference {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1);
        }
        public void setCanSetPreference(CanSetPreference callback) {
            canSetPreference.set(callback);
        }
        
        public Function<SetPreference> setPreference = function(SetPreference.class);
        public static interface SetPreference {
            @Delegate
            int invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1, jnr.ffi.Pointer value_2, jnr.ffi.Pointer stringUtf16_3);
        }
        public void setSetPreference(SetPreference callback) {
            setPreference.set(callback);
        }
        
        public Function<ClearCertificateExceptions> clearCertificateExceptions = function(ClearCertificateExceptions.class);
        public static interface ClearCertificateExceptions {
            @Delegate
            void invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer completionCallback_1);
        }
        public void setClearCertificateExceptions(ClearCertificateExceptions callback) {
            clearCertificateExceptions.set(callback);
        }
        
        public Function<CloseAllConnections> closeAllConnections = function(CloseAllConnections.class);
        public static interface CloseAllConnections {
            @Delegate
            void invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer completionCallback_1);
        }
        public void setCloseAllConnections(CloseAllConnections callback) {
            closeAllConnections.set(callback);
        }
        
        public Function<ResolveHost> resolveHost = function(ResolveHost.class);
        public static interface ResolveHost {
            @Delegate
            void invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1, jnr.ffi.Pointer resolveCallback_2);
        }
        public void setResolveHost(ResolveHost callback) {
            resolveHost.set(callback);
        }
        
        public Function<ResolveHostCached> resolveHostCached = function(ResolveHostCached.class);
        public static interface ResolveHostCached {
            @Delegate
            Errorcode invoke(jnr.ffi.Pointer requestContext, jnr.ffi.Pointer stringUtf16_1, jnr.ffi.Pointer void_2);
        }
        public void setResolveHostCached(ResolveHostCached callback) {
            resolveHostCached.set(callback);
        }
        
        public RequestContext(jnr.ffi.Runtime runtime) {
          super(runtime);
        }
    }
     ...
     * (Not documented)
     * 
     * @method requestContextGetGlobalContext()
     * @return [RequestContext] 
     * @scope class
     */
    public static RequestContext requestContextGetGlobalContext() {
        return INSTANCE.requestContextGetGlobalContext();
    }
    
    /**
     * (Not documented)
     * 
     * @method requestContextCreateContext(settings, handler)
     * @param [RequestContextSettings] settings 
     * @param [FFI::Pointer(*RequestContextHandler)] handler 
     * @return [RequestContext] 
     * @scope class
     */
    public static RequestContext requestContextCreateContext(RequestContextSettings settings, jnr.ffi.Pointer handler) {
        return INSTANCE.requestContextCreateContext(settings, handler);
    }
    
    /**
     * (Not documented)
     * 
     * @method createContextShared(other, handler)
     * @param [RequestContext] other 
     * @param [FFI::Pointer(*RequestContextHandler)] handler 
     * @return [RequestContext] 
     * @scope class
     */
    public static RequestContext createContextShared(RequestContext other, jnr.ffi.Pointer handler) {
        return INSTANCE.createContextShared(other, handler);
    }
    ...
    public static final class BrowserHost extends Struct {
        ...
        public static interface GetRequestContext {
            @Delegate
            RequestContext invoke(jnr.ffi.Pointer browserHost);
        }
     ...
     * @scope class
     */
    public static int browserHostCreateBrowser(WindowInfo windowInfo, Client client, StringUtf16 url, BrowserSettings settings, RequestContext requestContext) {
     ...
     * @scope class
     */
    public static Browser browserHostCreateBrowserSync(WindowInfo windowInfo, Client client, StringUtf16 url, BrowserSettings settings, RequestContext requestContext) {
    ...
    public interface CEFInterface {
        ...
        @NativeName("cef_request_context_get_global_context")
        RequestContext requestContextGetGlobalContext();
        
        @NativeName("cef_request_context_create_context")
        RequestContext requestContextCreateContext(RequestContextSettings settings, jnr.ffi.Pointer handler);
        
        @NativeName("cef_create_context_shared")
        RequestContext createContextShared(RequestContext other, jnr.ffi.Pointer handler);
        
        @NativeName("cef_browser_host_create_browser")
        int browserHostCreateBrowser(WindowInfo windowInfo, Client client, StringUtf16 url, BrowserSettings settings, RequestContext requestContext);
        
        @NativeName("cef_browser_host_create_browser_sync")
        Browser browserHostCreateBrowserSync(WindowInfo windowInfo, Client client, StringUtf16 url, BrowserSettings settings, RequestContext requestContext);
