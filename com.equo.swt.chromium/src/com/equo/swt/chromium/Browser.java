...
public class Browser extends Composite {
  ...
  public Browser(Composite parent, int style) {
    ...
    String msg = "";
    try {
      webBrowser = (WebBrowser) Class.forName("com.equo.swt.chromium.Chromium").newInstance();
    } catch (ClassNotFoundException e) {
      msg = "Cannot find Chromium class, probably you a missing a chromium.swt fragment.";
    ...
    dispose();
    SWT.error(SWT.ERROR_NO_HANDLES, null, msg);
  }
  ...
  static Composite checkParent(Composite parent) {
    ...
    /*
     * Note. Mozilla provides all IM support needed for text input in web pages. If
     * SWT creates another input method context for the widget it will cause
   ...
   * @param     url                      the URL that the cookie is associated
   *                                     with
   * @return                             the cookie value, or <code>null</code> if
   *                                     no such cookie exists
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the name is
   *                                     null</li>
   ...
   * instances. The <code>value</code> parameter must be a cookie header string
   * that complies with <a href="http://www.ietf.org/rfc/rfc2109.txt">RFC
   * 2109</a>. The value is passed through to the native browser unchanged.
   * 
   * <p>Example value strings: <code>foo=bar</code> (basic session cookie)
   ...
   * @return                             <code>true</code> if the cookie was
   *                                     successfully set and <code>false</code>
   *                                     otherwise
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the value is
   *                                     null</li>
   *                                     <li>ERROR_NULL_ARGUMENT - if the url is
   *                                     null</li>
   *                                     </ul>
  ...
  /**
   * Adds the listener to the collection of listeners who will be notified when
   * the window hosting the receiver should be closed.
   * <p>
  ...
  /**
   * Adds the listener to the collection of listeners who will be notified when
   * the current location has changed or is about to change.
   * <p>
   * This notification typically occurs when the application navigates to a new
   * location with {@link #setUrl(String)} or when the user activates a hyperlink.
   * </p>
   * @param     listener                 the listener which should be notified
   * @exception IllegalArgumentException
   *                                     <ul>
  ...
  /**
   * Adds the listener to the collection of listeners who will be notified when a
   * progress is made during the loading of the current URL or when the loading of
   * the current URL has been completed.
   * @param     listener                 the listener which should be notified
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the listener
  ...
  /**
   * Adds the listener to the collection of listeners who will be notified when
   * the title of the current document is available or has changed.
   * @param     listener                 the listener which should be notified
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the listener
  ...
  /**
   * Adds the listener to the collection of listeners who will be notified when a
   * window hosting the receiver needs to be displayed or hidden.
   * @param     listener                 the listener which should be notified
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the listener
   ...
   * 
   * <p>Executes a script containing javascript commands in the context of the
   * current document. If document-defined functions or properties are accessed by
   * the script then this method should not be invoked until the document has
   * finished loading (<code>ProgressListener.completed()</code> gives
   * notification of this).
   * @param     script                   the script with javascript commands
   * @return                             <code>true</code> if the operation was
   *                                     successful and <code>false</code>
   *                                     otherwise
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the script
   *                                     is null</li>
   *                                     </ul>
   * @exception SWTException
   *                                     <ul>
  ...
  /**
   * Attempts to dispose the receiver, but allows the dispose to be vetoed by the
   * user in response to an <code>onbeforeunload</code> listener in the Browser's
   * current page.
   * @return                 <code>true</code> if the receiver was disposed, and
   *                         <code>false</code> otherwise
   * @exception SWTException
   *                         <ul>
   ...
   * 
   * <p>Evaluates a script containing javascript commands in the context of the
   * current document. If document-defined functions or properties are accessed by
   * the script then this method should not be invoked until the document has
   * finished loading (<code>ProgressListener.completed()</code> gives
   * notification of this).
   * </p>
   * 
   * <p>If the script returns a value with a supported type then a java
   ...
   * </ul>
   * An <code>SWTException</code> is thrown if the return value has an unsupported
   * type, or if evaluating the script causes a javascript error to be thrown.
   * @param     script                   the script with javascript commands
   ...
   * @exception SWTException
   *                                     <ul>
   *                                     <li>ERROR_FAILED_EVALUATE when the script
   *                                     evaluation causes a javascript error to
   *                                     be thrown</li>
   *                                     <li>ERROR_INVALID_RETURN_VALUE when the
   *                                     script returns a value of unsupported
   *                                     type</li>
   *                                     <li>ERROR_THREAD_INVALID_ACCESS when
   *                                     called from the wrong thread</li>
   *                                     <li>ERROR_WIDGET_DISPOSED when the widget
   ...
   * Returns the result, if any, of executing the specified script.
   * <p>
   * Evaluates a script containing javascript commands. When <code>trusted</code>
   * is <code>true</code> script is executed in the context of Chrome with Chrome
   * security privileges. When <code>trusted</code> is <code>false</code> script
   * is executed in the context of the current document with normal privileges.
   * </p>
   * <p>
   ...
   * </p>
   * <p>
   * Note: Chrome security context is applicable only to Browsers with style
   * <code>SWT.Mozilla</code>.
   * </p>
   * @param     script                   the script with javascript commands
   * @param     trusted                  <code>true</code> or <code>false</code>
   *                                     depending on the security context to be
   *                                     used
   * @return                             the return value, if any, of executing
   *                                     the script
   * @exception IllegalArgumentException
   ...
   * subsequently viewed in the receiver, and <code>false</code> otherwise. Note
   * that this may not reflect the javascript enablement on the currently- viewed
   * page if <code>setJavascriptEnabled()</code> has been invoked during its
   * lifetime.
   ...
   *                         <code>String</code> if this is empty.<br>
   *                         <p>
   *                         Note, the exact return value is platform dependent.
   *                         For example on Windows, the returned string is the
   *                         proccessed webpage with javascript executed and
   *                         missing html tags added. On Linux and OS X, this
   *                         returns the original HTML before the browser has
   *                         processed it.
   *                         </p>
   * @exception SWTException
   *                         <ul>
   ...
   * @return                 the current URL or an empty <code>String</code> if
   ...
   * history item, and <code>false</code> otherwise.
   ...
   * @param     listener                 the listener which should no longer be
   *                                     notified
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the listener
  ...
  /**
   * Removes the listener from the collection of listeners who will be notified
   * when the current location is changed or about to be changed.
   * @param     listener                 the listener which should no longer be
   *                                     notified
   * @exception IllegalArgumentException
   *                                     <ul>
  ...
  /**
   * Sets whether javascript will be allowed to run in pages subsequently viewed
   ...
   * 
   * <p>The html parameter is Unicode-encoded since it is a java <code>String</code>.
   ...
   * @exception IllegalArgumentException
   *                                     <ul>
   *                                     <li>ERROR_NULL_ARGUMENT - if the html is
   *                                     null</li>
   *                                     </ul>
   * @exception SWTException
   *                                     <ul>
   ...
   * permissions.
   * 
   * <p>The <code>html</code> parameter is Unicode-encoded since it is a java
   ...
   * 
   * <p>The <code>trusted</code> parameter affects the permissions that will be
   ...
   * is not known.
   * @param     html                     the HTML content to be rendered
   * @param     trusted                  <code>false</code> if the rendered page
   *                                     should be granted restricted permissions
   ...
   * Begins loading a URL. The loading of its content occurs asynchronously.
   * 
   * <p>If the URL causes an HTTP request to be initiated then the provided
   ...
   * @param     url                      the URL to be loaded
   * @param     postData                 post data to be sent with the request, or
   *                                     <code>null</code>
   * @param     headers                  header lines to be sent with the request,
   *                                     or <code>null</code>
   * @return                             <code>true</code> if the operation was
   *                                     successful and <code>false</code>
   *                                     otherwise.
