...
//    .link("cef")
  ...
  let _ = gen
    ...
    .whitelist_type("_cef_jsdialog_handler_t")
    .opaque_type("_cef_jsdialog_callback_t")
    ...
    // .blacklist_type("_cef_main_args_t")
    // .blacklist_type("_cef_window_info_t")
    .raw_line("package com.equo.swt.internal.chromium;")
    .raw_line("import com.equo.swt.internal.chromium.CEFFactory.cef_base_ref_counted_t;")
