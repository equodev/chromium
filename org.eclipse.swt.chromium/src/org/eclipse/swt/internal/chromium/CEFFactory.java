...
public class CEFFactory {
    ...
    private static DefaultTypeMapper getClosureTypeMapper() {
        try {
            if (typeMapper == null) {
                ...
                Collection<SignatureTypeMapper> signatureTypeMappers = (Collection<SignatureTypeMapper>) signatureTypeMappersField
                        .get(compTypeMapper);
    ...
    public static void mapTypeForClosure(Class<? extends Struct> structClass) {
        ...
        if (typeMapper != null) {
            typeMapper.put(structClass,
                    StructByReferenceFromNativeConverter.getInstance(structClass, closureToNativeContext));
        }
    }
    ...
    public enum ReturnType implements IntegerEnum {
    ...
    public static class FunctionSt extends Struct {
        static {
            mapTypeForClosure(FunctionSt.class);
        }
